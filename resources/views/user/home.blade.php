...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>Sektor Kreatif - Home</title>
					...
					<div id="page-header" class="ph-full ph-cap-sm ph-image-cropped ph-image-cover-3 ph-content-parallax">
						<div class="page-header-inner tt-wrap">
							...
							<div class="ph-caption max-width-1000">
								<h1 class="ph-caption-title ph-appear font-normal"><em>Halo Semua!</em><br> <b>Sektor Kreatif</b>  merupakan<br><em><u>solusi</u></em> produk kreatif dan <br>editing profesional untuk <br>komunitas brand Anda.</h1>
										...
										<div class="swiper-wrapper">
											...
											<div class="swiper-slide font-alter">
												<div class="tt-ts-item">
													...
													<div class="tt-ts-subtext">- {{$test->username}}</div>
												</div>
											</div>
											<!-- End swiper slide -->
                                            @endforeach
							...
							<div class="tt-section-inner tt-wrap">
								...
								* Use prepared helper class "max-width-*" to add custom width if needed. Example: "max-width-800". More info about helper classes can be found in the file "helper.css".
								...
								<div class="tt-heading tt-heading-xxlg tt-heading-stroke tt-heading-center margin-bottom-10-p anim-fadeinup">
									...
									<h2 class="tt-heading-title">Mitra</h2>
								...
								* Hint: for better results make sure all your images are in the same dimensions!
								...
								<ul class="tt-logo-wall cl-col-44 anim-fadeinup">
									...
									<li><a href="#" class="cursor-alter" target="_blank" rel="noopener"><img src="{{$mit->logo}}" alt="Client" style="
                                        float: center;
                                        width:  150px;
                                        height: 150px;
						...
						* You can use padding classes if needed. For example "padding-top-xlg-150", "padding-bottom-xlg-150", "no-padding-top", "no-padding-bottom", etc. Note that each situation may be different and each section may need different classes according to your needs. More info about helper classes can be found in the file "helper.css".
						...
						<div class="tt-section">
							<div class="tt-section-inner tt-wrap">
								...
								<div class="tt-row">
									<div class="tt-col-lg-6 padding-center-lg-5-p">
										...
										* Use prepared helper class "max-width-*" to add custom width if needed. Example: "max-width-800". More info about helper classes can be found in the file "helper.css".
										...
										<div class="tt-heading tt-heading-lg margin-bottom-10-p anim-fadeinup">
											...
											<h2 class="tt-heading-title">Contact</h2>
										</div>
										<!-- End tt-Heading -->
										...
										<ul class="tt-contact-info padding-bottom-40 text-gray">
											...
											<li class="anim-fadeinup">
												...
												<a href="mailto:{{$profile[0]->company_email}}" class="tt-link">{{$profile[0]->company_email}}</a>
											</li>
										</ul>
                                        <form id="tt-contact-form" class="tt-form-minimal anim-fadeinup">
											<div class="tt-btn tt-btn-light-outline margin-top-40">
                                                <a href="whatsapp://send?text=Hai, saya ingin buat video!&phone={{$profile[0]->company_phone}}" data-hover="CONTACT US">CONTACT US</a></center>
											</div>
										</form>
										<!-- End contact info -->
