...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>Sektor Kreatif | Galleries</title>
						...
						<div class="page-header-inner tt-wrap">
							...
							<div class="ph-image">
								<div class="ph-image-inner">
									<img src="/user-template/assets/img/page-header/ph-1.jpg" alt="Image">
								</div>
							</div>
							...
							===============================
							Use class "max-width-*" to set caption max width if needxed. For example "max-width-1000". More info about helper classes can be found in the file "helper.css".
							-->
							<div class="ph-caption">
								<h1 class="ph-caption-title ph-appear">Gallery</h1>
								<div class="ph-caption-title-ghost ph-appear">Gallery</div>
								<div class="ph-caption-subtitle ph-appear">All</div>
							</div>
						...
						<div id="sdc-target" class="tt-section padding-bottom-150">
							<div class="tt-section-inner">
								...
								* Use class "pli-info-sm", "pli-info-lg", "pli-info-xlg" or "pli-info-xxlg" to set item info size (no class = default size!)
								-->
								<div class="portfolio-list pli-cropped pli-info-xlg pl-alter pli-info-overlay pli-title-stroke pli-hover">
										...
										<div class="pli-inner">
											...
											<div class="pli-image-col">
												<a href="/gallery/{{$gallery->gallery_id}}" class="pli-image-link" data-cursor="View<br>Project">
													...
													<div class="pli-info-col pli-info-inner">
														<div class="pli-info">
															<h2 class="pli-title">{{$gallery->title}}</h2> <!-- You can use <br class="hide-from-sm"> to break a text line if needed -->
															<div class="pli-categories-wrap">
																<div class="pli-category">{{ucwords(str_replace( array( '\'', '"', ',' , ';', '<', '>', '-' ), ' ', $gallery->category))}}</div>
											...
											<div class="pli-info-col pli-info-outer">
												<div class="pli-info">
													...
													<h2 class="pli-title"><a href="/gallery/{{$gallery->gallery_id}}">{{$gallery->title}}</a></h2> <!-- You can use <br class="hide-from-sm"> to break a text line if needed -->
													<div class="pli-categories-wrap">
														<div class="pli-category">{{ucwords(str_replace( array( '\'', '"', ',' , ';', '<', '>', '-' ), ' ', $gallery->category))}}</div>
														<!-- <div class="pli-category">Varia</div> -->
													</div> <!-- /.pli-categories-wrap -->
							...
							<div class="tt-section-inner tt-wrap">
								...
								* Use class "tt-pn-scroll" to enable hover title scroll. Note: If "tt-pn-hover-title" text is wider than "tt-pn-link" then it scrolls by default. The longer the text, the faster it scrolls.
								...
								<div class="tt-page-nav tt-pn-scroll">
									<a href="whatsapp://send?text=Hai, saya ingin buat video!&phone={{$profile[0]->company_phone}}" class="tt-pn-link anim-fadeinup">
									...
									<div class="tt-pn-image">
										<img src="/user-template/assets/img/page-header/ph-3.jpg" alt="image">
									</div>
								</div>
								<!-- End page nav -->
							...
							<div class="footer-col tt-align-center order-m-last">
								<div class="footer-col-inner">
									...
									<div class="tt-copyright">
										© Copyright - <a href="https://themetorium.net" target="_blank" rel="noopener" class="tt-link">Sektor Kreatif</a>
									</div>
